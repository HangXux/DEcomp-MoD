...
import numpy as np
from datasets.aapmct import AAPMCT
...
def get_dataset(args, config):
    ...
    elif config.data.dataset == "AAPMCT":
        train_folder = "{}/train".format(config.data.category)
        test_folder = "{}/test".format(config.data.category)
        dataset = AAPMCT(os.path.join(args.exp, "datasets", train_folder), transform=tran_transform,
                         downsample=config.data.downsample)
        test_dataset = AAPMCT(os.path.join(args.exp, "datasets", test_folder), transform=test_transform,
                              downsample=config.data.downsample)
